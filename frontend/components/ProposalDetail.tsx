...
import {
  ArrowLeft, Cpu, Send, Sparkles, X, Minimize2, Maximize2, MoreHorizontal
} from 'lucide-react';
      ...
      <div className="h-18 px-8 py-5 flex items-center justify-between border-b border-zinc-100 bg-white/40 backdrop-blur-md z-20">
         ...
         <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2 text-zinc-400">
               <div className="w-8 h-8 rounded-full hover:bg-zinc-100 flex items-center justify-center cursor-pointer transition-colors"><Minimize2 size={16} /></div>
               <div className="w-8 h-8 rounded-full hover:bg-zinc-100 flex items-center justify-center cursor-pointer transition-colors"><Maximize2 size={16} /></div>
               <div className="w-8 h-8 rounded-full hover:bg-rose-100 hover:text-rose-500 flex items-center justify-center cursor-pointer transition-colors" onClick={onBack}><X size={16} /></div>
            </div>
         </div>
      </div>

      <div className="flex-1 flex overflow-hidden">
         {/* LEFT: Document Area (Scrollable) */}
         <div className="hidden lg:block w-[55%] h-full overflow-y-auto custom-scrollbar p-10 bg-gradient-to-b from-white/50 to-zinc-50/50">
         ...
         <div className="w-full lg:w-[45%] h-full flex flex-col bg-white/60 border-l border-white/50 relative backdrop-blur-xl">
